  ...
  const categories = [
    {
      ...
      items: [
        { name: "TypeScript", dot: "bg-blue-500", logo: "https://cdn.simpleicons.org/typescript/3178C6" },
        { name: "React", dot: "bg-cyan-400", logo: "https://cdn.simpleicons.org/react/61DAFB" },
        { name: "Next.js", dot: "bg-white", logo: "https://cdn.simpleicons.org/nextdotjs/ffffff" },
        { name: "Svelte", dot: "bg-orange-500", logo: "/images/tech/svelte.png" },
        { name: "Tailwind CSS", dot: "bg-cyan-500", logo: "https://cdn.simpleicons.org/tailwindcss/06B6D4" }
      ]
    },
    {
      id: "backend",
